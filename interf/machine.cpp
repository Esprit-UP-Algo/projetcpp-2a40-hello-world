...
machine::machine(QString serie,int nb_heures,QString etat,QString fonction,QString position,int q_carburant)
{
    this->serie=serie;
    this->etat=etat;
...
bool machine::ajouter()
{
    ...
    QSqlQuery query;
         query.prepare("INSERT INTO machines (serie, nombre_heure,etatm,fonction,position,qnt_carburant) "
                       "VALUES (:serie,:nombre_heure, :etatm, :fonction,:position,:qnt_carburant)");
...
QSqlQueryModel* machine::afficher()
{
    QSqlQueryModel* model=new QSqlQueryModel();
      model->setQuery("SELECT serie,nombre_heure,etatm,fonction,position,qnt_carburant FROM machines ORDER BY fonction ASC");
          ...
          model->setHeaderData(5, Qt::Horizontal, QObject::tr("qnt_carburant"));
